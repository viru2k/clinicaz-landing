   ...
   if(currentUser['access_token'] != ''){
     ...
     //   this.asignarModulos(userData['access_list']);
       ...
       if(userCuenta){
         ...
         this.nombreyapellido = userCuenta[0]['titular_apellido']+' '+userCuenta[0]['titular_nombre'];
         this.cantidad_clinicas = userCuenta[0]['cantidad_clinicas'];
         this.cantidad_usuarios = userCuenta[0]['cantidad_usuarios'];
         this.clinica = userCuenta[0]['clinica'];
         this.cuenta_estado = userCuenta[0]['cuenta_estado'];
         this.email = userCuenta[0]['email'];
         this.importe_mensual = userCuenta[0]['importe_mensual'];
         this.name = userCuenta[0]['titular_telefono'];
         this.fecha_alta = userCuenta[0]['fecha_creacion']; 
       }
   }else{
